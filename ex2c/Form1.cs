...
namespace ex2c
{
    public partial class Form1 : Form
    {
        ...
        private string sbyte1;
        private string sbyte2;
        ...
        private void setMinButton_TextChanged(object sender, EventArgs e)
        {
            ...
            int1 = Int16.MinValue; int1TextBox.Text = int1.ToString();
        ...
        private void setMaxButton_TextChanged(object sender, EventArgs e)
        {
            ...
            byte2 = Byte.MinValue; byte1TextBox.Text = byte2.ToString();
            sbyte2 = SByte.MinValue; sbyte1TextBox.Text = sbyte2.ToString();
            short2 = Int16.MinValue; short1TextBox.Text = short2.ToString();
            ushort2 = UInt16.MinValue; ushort1TextBox.Text = ushort2.ToString();
            int2 = Int16.MinValue; int1TextBox.Text = int2.ToString();
            uint2 = UInt32.MinValue; uint1TextBox.Text = uint2.ToString();
            long2 = Int64.MinValue; long1TextBox.Text = long2.ToString();
            ulong2 = UInt64.MinValue; ulong1TextBox.Text = ulong2.ToString();
            float2 = Single.MinValue; float1TextBox.Text = float2.ToString();
            double2 = Double.MinValue; double1TextBox.Text = double2.ToString();
            decimal2 = Decimal.MinValue; decimal1TextBox.Text = decimal2.ToString();
        }
        ...
        private void addButton_Click(object sender, EventArgs e, byte byte3)
        {
            byte byte1, byte2, byte3;
            sbyte sbyte1, sbyte2, sbyte3;
            short short1, short2, short3;
